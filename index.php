...
<body>
  <div class="wrap">
    <section id="login">
      <canvas id="particles-login" class="particles"></canvas>
      <div class="titlebox">
        <h1>EchoMind</h1>
        <p class="subtitle">A meditative memory puzzle by <strong>Eleni D.</strong></p>
      </div>
      <div class="panel">
        <h2>Welcome, <?php echo htmlspecialchars($username); ?> ✨</h2>
        <button id="login-btn">Begin</button>
        <p class="hint">Watch the sequence. Remember. Repeat the pattern.</p>
      </div>
      <button id="about-btn" class="icon-btn" title="About">?</button>
      <button id="mute-btn" class="icon-btn" title="Sound">🔊</button>
    ...
    <section id="prestart" class="hidden">
      <canvas id="particles" class="particles"></canvas>
      <div class="centerbox">
        <h2>Welcome, <span id="playername"><?php echo htmlspecialchars($username); ?></span></h2>
        <p class="hint">Breathe in. Watch the light. Let memory bloom.</p>
        <button id="start-btn">Start Puzzle</button>
      </div>
<div class="multiplayer">
        <button id="host-btn" class="ghost small">Host Multiplayer</button>
        <button id="join-btn" class="ghost small">Join</button>
      </div>
  ...
  <script>
    // Pass PHP username to JS cleanly
